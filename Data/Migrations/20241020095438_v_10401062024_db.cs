    ...
    public partial class v_10401062024_db : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("902e9054-950e-4d67-ab34-05e7847cd5fb"), "f81072b5-85db-423a-bc76-daebd924429f", "Admin", "ADMIN" },
                    { 2, new Guid("c6da38d3-70a4-4be4-951b-4982baf381b9"), "5b0647ce-bde0-4237-9946-4cc35ee0d917", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, new Guid("7600dfd2-1dcc-4b2d-9342-27716c7a014c"), "101e31a5-f1a1-4d45-9c63-6b67320218f2", new DateTime(2024, 10, 20, 9, 54, 37, 828, DateTimeKind.Utc).AddTicks(4778), "admin@mail.com", true, false, null, "ADMIN@MAIL.COM", "ADMIN", "AQAAAAEAACcQAAAAEAV5fJWNEvI0P9gnYCXsr+Cq5MPcxtsJb8+K9bnKa3oG14hoNxtqQzv8RmIIb5/Tww==", null, false, "", false, "admin" });

            migrationBuilder.InsertData(
                table: "asp_net_user_roles",
                columns: new[] { "RoleId", "UserId", "AlternateId", "CreatedBy", "CreatedDate", "UpdateBy", "UpdateDate" },
                values: new object[] { 1, 1, new Guid("c0cb46dc-c65a-4f75-aa30-a120435486ba"), "migration_seeding", new DateTime(2024, 10, 20, 9, 54, 37, 840, DateTimeKind.Utc).AddTicks(9189), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
